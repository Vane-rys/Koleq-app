...
import { GraduationCap, House, FileText, User, ChevronDown } from 'lucide-react-native';
...
import { mockApoderado, mockNotas } from '../data/mockHome';
...
const hijo = mockApoderado.hijos[0]; // Notas de Emilia (ver mockHome.ts)

export function NotasScreen({ navigation }: Props) {
      ...
      {semestre.materias.length === 0 ? (
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyText}>
            Cuando los profesores registren la primera evaluación, aparecerá aquí.
          </Text>
        </View>
      ) : (
              ...
              <HomeCard key={m.nombre} style={styles.expandedCard}>
                ...
                >
                  <View>
                    ...
                    <Text style={styles.materiaProfe}>
                      {m.profesor} · {m.evaluaciones} evaluaciones
                    </Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  promedioValor: { fontFamily: 'PlusJakartaSans_700Bold', color: colors.blanco, fontSize: 24, marginTop: 2 },
  ...
  notaValor: { fontFamily: 'PlusJakartaSans_700Bold', color: colors.indigo, fontSize: 16 },
